...
export const AccessoriesService = {
    ...
    GetAnalysisHistory(accessoriesId) {
        let url = "supply/accessories/analysis-history";
        return api.post(url, { accessoriesId });
    },

    // 7. Xomashyolar ro'yxatini Excel formatida yuklab olish
    ExportExcel(payload) {
        let url = "supply/accessories/export-excel";
        return api.post(url, payload, {
    ...
    UpdateStock(payload) {
        let url = "supply/accessories/update-stock";
        return api.post(url, payload);
    }
};