...
const exportOptions = [
  { id: 'excel', label: 'Excel Report', description: "To'liq jadval (.xlsx)", icon: 'fa-solid fa-file-excel', theme: 'emerald', badge: 'PRO' },
  { id: 'pdf', label: 'PDF Document', description: "Chop etish uchun (.pdf)", icon: 'fa-solid fa-file-pdf', theme: 'rose' }
];
